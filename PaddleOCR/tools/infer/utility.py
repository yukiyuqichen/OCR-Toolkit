...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default="./models/ch_PP-OCRv3_det_infer/")
    ...
    parser.add_argument("--rec_model_dir", type=str, default="./models/ch_PP-OCRv3_rec_infer/")
    ...
    parser.add_argument("--cls_model_dir", type=str, default="./models/ch_ppocr_mobile_v2.0_cls_infer/")
    ...
    #
    parser.add_argument(
        "--draw_img_save_dir", type=str)
    parser.add_argument("--save_crop_res", type=str2bool, default=False)
    parser.add_argument("--crop_res_save_dir", type=str)
    ...
    parser.add_argument("--save_log_path", type=str)
