...
# 在本地部署PaddleOCR
def ocr_paddle(frame_ocr, ocr_select_dir_path, ocr_save_dir_path, process, process_end, file_num, count_num):
    ...
    try:
        predict.main(args, frame_ocr, process, process_end, file_num, count_num)
    except Exception as e:
        process_end.set(str(e))
        frame_ocr.update()
